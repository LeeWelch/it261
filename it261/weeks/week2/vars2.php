<?php
// concatenation
// operators - assignment operators - the equals sign
...
echo '<br>';
echo 'Lee\'s favorite color is '.$color.' ';
...
echo '<br>';
echo date('l'); //day is lowercase l
echo '<br>';
...
echo $fruit[2]; //numbering in php starts at 0
